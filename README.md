...
# 🎮 Stonewards — Community Edition

**Medieval fortress strategy, complete and ready to play.**
...
Stonewards is a medieval strategy and fortress management game in which players design, build, and defend their own stronghold across a full campaign and free-form sandbox mode. This Community Edition is a standalone build containing the complete game and all released content in a self-contained package. It runs entirely offline, with no storefront or additional software required.

This build is for strategy and city-building fans who want a complete, offline, single-package version of Stonewards for Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4502710/b53d325e1fa0feb617e60f1a15321a7608c29bb3/ss_b53d325e1fa0feb617e60f1a15321a7608c29bb3.1920x1080.jpg?t=1786868537" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4502710/9e3a20d5498f75e3f43a0934358bf94cdf42fa70/ss_9e3a20d5498f75e3f43a0934358bf94cdf42fa70.1920x1080.jpg?t=1786868537" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4502710/65256087a9f660ac7a029013ca249110d7f8ff12/ss_65256087a9f660ac7a029013ca249110d7f8ff12.1920x1080.jpg?t=1786868537" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏰 **Fortress Construction** — Design layered stone keeps, walls, and defensive works with a grid-free building system.
- 📜 **Full Campaign Included** — Complete single-player campaign with all chapters and scenarios in this release.
- 🧱 **Sandbox Mode** — Unlimited resources and open maps for unrestricted fortress building.
- 🌦️ **Dynamic Seasons** — Weather, harvest cycles, and winter sieges affect supply and defense planning.
- 🛠️ **Mod Support** — Community mod loader included for custom maps, units, and building sets.
- 🌐 **LAN Multiplayer** — LAN or direct P2P connection supported for cooperative and versus play.
- 📴 **Fully Offline** — Playable without an internet connection after installation.
- 📦 **Self-Contained Package** — Single directory install with all dependencies bundled; no additional software required.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~11 on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — complete single-package install

---

## 📦 DLCs Included

- Stoneguard Expansion
- Winterkeep Pack
- Royal Arsenal Kit
...
| **Processor** | Intel Core i5-4460 or AMD FX-6300 | Intel Core i5-10400 or AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
...
| **Storage** | 12 GB available space | 12 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12 compatible sound card; keyboard and mouse required |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Stonewards\Saved`
